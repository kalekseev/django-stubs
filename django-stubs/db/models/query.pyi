...
class QuerySet(AltersData, _SupportsContains[object], Iterable[_Row], Sized, Generic[_Model, _Row]):
    ...
    def __class_getitem__(cls, item: type[_Model]) -> Self: ...  # pyright: ignore[reportGeneralTypeIssues]
...
class Prefetch(Generic[_Model]):
    ...
    def get_current_querysets(self, level: int) -> list[QuerySet[Any]] | None: ...

def prefetch_related_objects(model_instances: Iterable[Model], *related_lookups: str | Prefetch[Any]) -> None: ...
